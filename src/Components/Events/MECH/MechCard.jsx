        ...
        >
          ...
          {hovered === content.id && (
            <div className="absolute z-50 top-[22%] left-[5%]  p-6 flex flex-col justify-between gap-4 w-[80%] sm:w-[95%]">
              ...
              <Link to={`/event/MECH/${content.eventTitle}`} className="text-[13px] text-center flex items-center font-bold  w-[60%] p-3 rounded-[2px] bg-white cursor-pointer hover:bg-transparent hover:border border-gray-500 hover:shadow-lg">
                Register Now&#160;
                <Register />
              </Link>
            </div>
